...
const AIAssistant = ({ message }: AIAssistantProps) => {
  return (
    <div className="absolute bottom-8 left-[100px] md:left-[120px] lg:left-[160px] xl:left-[200px] flex items-center gap-3 z-20 pointer-events-none">
      ...
      {/* Speech bubble - constrained to fit in safe clearance zone */}
      {message && (
